...
```
drwxr-x--- 2 root root       4096 Jun 21 08:46 .
drwxr-x--- 3 root root       4096 Jun 21 08:46 ..
-rw-r--r-- 1 root root 9388029929 Jun 21 08:48 rocm-installer_1.2.6.70201-48-81~24.04.run
```
